...
import edu.byu.cs.tweeter.client.presenter.presenters.MainPresenter;
...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    @Override
    // Replaces updateFollowButton(boolean removed). Was duplicate code, except uses internationalized strings
